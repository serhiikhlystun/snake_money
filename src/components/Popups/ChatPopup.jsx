...
const ChatPopup = ({ isOpen, onClose, groups, people }) => {
            ...
            <div className="chat-popup__content">
                ...
                <div className="chat-popup__chats">
                    <div className="chat-popup__search-container">
                        <svg className="chat-popup__search-icon" width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <div className="chat-popup__users groups">
                        <h4 className="chat-popup__users-title">
                            Groups
                        </h4>
                        <ul className="chat-popup__users-list">
                            {groups.map((group, index) => (
                                <li key={index} className="chat-popup__users-item">
                                    <Image className="chat-popup__users-item-img" width={40} height={40} src={group.img} alt={group.name}/>
                                    <div className="chat-popup__users-item-wrapp">
                                        ...
                                        <div className="chat-popup__users-item-box rightAlign">
                                            ...
                                            <p className={`chat-popup__users-item-time-checked ${group.messageCount !== 0 ? 'unread' : ''}`}>
                    ...
                    <div className="chat-popup__users people">
                        ...
                        <ul className="chat-popup__users-list">
                            {people.map((person, index) => (
                                <li key={index} className="chat-popup__users-item">
                                    <Image className="chat-popup__users-item-img" width={40} height={40} src={person.img} alt={person.name}/>
                                    <div className="chat-popup__users-item-wrapp">
                                        <div className="chat-popup__users-item-box">
                                        ...
                                        <div className="chat-popup__users-item-box rightAlign">
                                            ...
                                            <p className={`chat-popup__users-item-time-checked ${person.messageCount !== 0 ? 'unread' : ''}`}>
                ...
                <div className="chat-popup__chat">
                    <div className="chat-popup__chat-header">
                        ...
                        <Image className="chat-popup__chat-header-avatar" width={64} height={64} src={icon05} alt=""/>
                    </div>
                    ...
                    <div className="chat-popup__chat-input-inner">
                        ...
                        <button className="chat-popup__chat-send-button" onClick={handleSendMessage}>
