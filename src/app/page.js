...
function App() {
    ...
    const sidebarContentLeft = [
        ...
        { content: <Image src={fixIcon} alt="fix icon" />, className: 'square', onClick: openSettingsPopup },
    ];

    const sidebarContentRight = [
        { content: 'WHITEPAPER', onClick: openWhitepaperPopup },
        { content: 'ABOUT', onClick: openAboutPopup },
        { content: <Image src={chatIcon} alt="chat icon" />, className: 'square', onClick: openChatPopup },
    ];

    const groups = [
        { img: icon01, name: 'Friends Forever', text: 'Message from Group 1', time: 'Today, 10:00 AM', messageCount: 2 },
        { img: icon02, name: 'Mera Gang', text: 'Message from Group 2', time: 'Yesterday, 11:00 AM', messageCount: 0 },
        { img: icon03, name: 'Hiking', text: 'Message from Group 3', time: 'May 15, 12:00 PM', messageCount: 1 },
        { img: icon02, name: 'Car fest', text: 'Message from Group 3', time: 'May 15, 12:00 PM', messageCount: 1 },
        { img: icon01, name: 'Drunking', text: 'Message from Group 3', time: 'May 15, 12:00 PM', messageCount: 1 },
    ];

    const people = [
        { img: icon01, name: 'Jonny', text: 'Message from Person 1', time: 'Today, 1:00 PM', messageCount: 0 },
        { img: icon02, name: 'Pedro', text: 'Message from Person 2', time: 'Yesterday, 2:00 PM', messageCount: 3 },
        { img: icon03, name: 'Martin', text: 'Message from Person 3', time: 'May 10, 3:00 PM', messageCount: 0 },
        { img: icon04, name: 'Fernando', text: 'Message from Person 4', time: 'May 9, 4:00 PM', messageCount: 0 },
        { img: icon05, name: 'Arni', text: 'Message from Person 5', time: 'May 8, 5:00 PM', messageCount: 5 },
        { img: icon06, name: 'Person 6', text: 'Message from Person 6', time: 'May 7, 6:00 PM', messageCount: 0 },
        { img: icon01, name: 'Person 7', text: 'Message from Person 7', time: 'May 6, 7:00 PM', messageCount: 0 },
        { img: icon02, name: 'Person 8', text: 'Message from Person 8', time: 'May 5, 8:00 PM', messageCount: 1 },
        { img: icon03, name: 'Person 9', text: 'Message from Person 9', time: 'May 4, 9:00 PM', messageCount: 0 },
        { img: icon04, name: 'Person 10', text: 'Message from Person 10', time: 'May 3, 10:00 PM', messageCount: 2 },
        { img: icon05, name: 'Person 11', text: 'Message from Person 11', time: 'May 2, 11:00 PM', messageCount: 0 },
        { img: icon06, name: 'Person 12', text: 'Message from Person 12', time: 'May 1, 12:00 AM', messageCount: 0 },
        { img: icon01, name: 'Person 13', text: 'Message from Person 13', time: 'April 30, 1:00 AM', messageCount: 0 },
        { img: icon02, name: 'Person 14', text: 'Message from Person 14', time: 'April 29, 2:00 AM', messageCount: 0 }
    ];
    ...
    return (
        <div className="App" style={{ fontFamily: 'Ravi Prakash, system-ui' }}>
            {isPortrait && <RotateMessage />}
            <div className="homepage">
                <div className="container">
                    <Header />
                    <SideBar content={sidebarContentLeft} sideClass="left" />
                    <Slider openStartPopup={openStartPopup} closePopups={closePopups} openLoginPopup={openLoginPopup} openRegPopup={openRegPopup} />
